...
function revealOnScroll() {
    const reveals = document.querySelectorAll('.about-text, .contact-content');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    style.textContent = `
        ...
        .about-text.revealed, .contact-content.revealed {
            opacity: 1;
...
console.log(`
🍫 Welcome to xzyyysh's Portfolio! 🍫
Built with love, coffee, and dark chocolate vibes.
Feel free to explore the code!

Contact: nissanby001@gmail.com
GitHub: https://github.com/xzyyysh
`);
...
document.addEventListener('keydown', (e) => {
    ...
    if (konamiCode.join(',') === konamiSequence.join(',')) {
        ...
        setTimeout(() => {
            ...
            alert('🎉 Easter egg found! You know the code! 🎉');
        }, 2000);
        konamiCode = [];
    }
});
